...
Noms de fichiers en kebab-case, liens Markdown relatifs. Utiliser `<...>` autour d'une destination comportant des espaces. Vérifier la cible des liens. Lire l'index pertinent puis rechercher si l'index ne suffit pas.
...
Le journal `log.md` reçoit une entrée courte datée pour les changements structurants. Les bilans vivent dans `.ai/bilans/`, avec un nom distinct à chaque sujet ou clôture. Ne pas écraser un bilan du même jour. Après déplacement, corriger les liens et index ; après révision, préserver la provenance.
